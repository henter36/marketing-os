...
```text
brief_suggestion.generate
brief_suggestion.accept
brief_suggestion.reject
campaign_brief_keyword.create
campaign_brief_keyword.read
campaign_brief_keyword.update
audience_insight_snapshot.create
audience_insight_snapshot.read
brand_fit_signal.create
brand_fit_signal.read
tracking_domain.create
tracking_domain.read
tracking_domain.update
campaign_utm_template.create
campaign_utm_template.read
campaign_utm_template.update
tracking_event.ingest
tracking_event.read
creator.read
creator.create
creator.update
creator_match.generate
creator_outreach_draft.generate
creator_collaboration.create
creator_collaboration.update_status
channel_variant.create
channel_variant.read
publish_intent.create
publish_intent.read
publish_intent.approve
publish_attempt.create
publish_attempt.read
publish_status_history.read
