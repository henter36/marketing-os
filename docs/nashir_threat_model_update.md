...
| False evidence submission | User submits fake screenshot, wrong URL, wrong channel, or wrong external post. | Evidence, screenshots, evidence references | Manual Publishing Evidence Contract. | Evidence review authority, required fields, correction/invalidated states, audit trail. | High | Block before implementation. |
