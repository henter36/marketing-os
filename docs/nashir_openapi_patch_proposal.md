...
| Campaign basics | Campaign paths. | Reuse existing campaign list/create/get/update surfaces. | no | no | None. | Minimal risk as existing APIs are sufficient. | Reuse existing campaign APIs. |
